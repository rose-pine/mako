<p align="center">
    ...
    <h2 align="center">Rosé Pine for mako</h2>
</p>
...
1. Copy the contents of `themes/rose-pine-<variant>.theme` into `$XDG_CONFIG_HOME/mako/config`
...
```sh
npx @rose-pine/build@0.9.1 -t template.theme -o theme
```
